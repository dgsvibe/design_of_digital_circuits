...
-- sel	=>  Location: PIN_L3,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \s~0_combout\ = (\sel~input_o\ & (\e1[0]~input_o\)) # (!\sel~input_o\ & ((\e0[0]~input_o\)))
...
-- Equation(s):
-- \s~1_combout\ = (\sel~input_o\ & (\e1[1]~input_o\)) # (!\sel~input_o\ & ((\e0[1]~input_o\)))
...
-- Equation(s):
-- \s~2_combout\ = (\sel~input_o\ & (\e1[2]~input_o\)) # (!\sel~input_o\ & ((\e0[2]~input_o\)))
...
-- Equation(s):
-- \s~3_combout\ = (\sel~input_o\ & (\e1[3]~input_o\)) # (!\sel~input_o\ & ((\e0[3]~input_o\)))
...
-- Equation(s):
-- \s~4_combout\ = (\sel~input_o\ & (\e1[4]~input_o\)) # (!\sel~input_o\ & ((\e0[4]~input_o\)))
...
-- Equation(s):
-- \s~5_combout\ = (\sel~input_o\ & ((\e1[5]~input_o\))) # (!\sel~input_o\ & (\e0[5]~input_o\))
...
-- Equation(s):
-- \s~6_combout\ = (\sel~input_o\ & (\e1[6]~input_o\)) # (!\sel~input_o\ & ((\e0[6]~input_o\)))
...
-- Equation(s):
-- \s~7_combout\ = (\sel~input_o\ & ((\e1[7]~input_o\))) # (!\sel~input_o\ & (\e0[7]~input_o\))
...
-- Equation(s):
-- \s~8_combout\ = (\sel~input_o\ & ((\e1[8]~input_o\))) # (!\sel~input_o\ & (\e0[8]~input_o\))
...
-- Equation(s):
-- \s~9_combout\ = (\sel~input_o\ & ((\e1[9]~input_o\))) # (!\sel~input_o\ & (\e0[9]~input_o\))
